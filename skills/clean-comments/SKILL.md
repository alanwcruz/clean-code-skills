---
name: clean-comments
description: Use when writing, fixing, editing, or reviewing TypeScript comments and JSDoc/TSDoc. Enforces Clean Code principles—no metadata, no redundancy, no commented-out code.
---
